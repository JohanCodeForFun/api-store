...
<div class="container mt-2 mb-2">
   ...
   -->
						<div class="d-grid">
							<button type="button" class="btn btn-warning  btn-lg m-2">Get your spring jacket here!</button>
						</div>
					</div>
				</div>
			</div>
...
<style scoped>
.container {
	background-image: 'src/assets/dami-adebayo-k6aQzmIbR1s-unsplash.jpg';
}
	/* div {
		color: black;
		display: flex;
